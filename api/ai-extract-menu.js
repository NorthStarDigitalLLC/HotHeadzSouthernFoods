...
8a. READ ONLY THE LUNCH SECTION. Breakfast, breakfast sandwiches, the salad bar, drinks, and dessert are standing sections that the website already stores and prints; they are never part of this draft. If the photo shows a whole menu board, take only the dishes under the lunch or daily heading and ignore every other section, even when those items are food. Scrambled eggs, bacon, pancakes, biscuits, grits, breakfast burritos, lettuce, salad toppings, dressings, teas, sodas, coffee, and cake all belong to those standing sections — never put them in meats or sides. A handful of lunch mains plus their sides is the expected size of this draft; a list of thirty items means other sections were swept in by mistake.
